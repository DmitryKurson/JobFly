...
{
    /// <inheritdoc />
    public partial class UpdateUserInheritance : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MustToHave = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GoodToHave = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeTags", x => new { x.EmployeeId, x.TagId });
                    table.ForeignKey(
                        name: "FK_EmployeeTags_AspNetUsers_EmployeeId",
